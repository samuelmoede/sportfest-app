...
- Zeitplanung vervollständigt und verifiziert: Spielzeit und Wechselzeit werden pro Turnier verwendet, der Startabstand ergibt sich aus ihrer Summe und Schiedsrichtertimer zählen ausschließlich die Spielzeit. Die Spielplanbearbeitung zeigt nun das aktive Zeitmodell sowie eine Endzeit-Prognose insgesamt und pro Feld; Überschreitungen der geplanten Wettbewerbs-Endzeit werden in der Generatorvorschau als nicht blockierender Hinweis markiert.
- Ortsmodell und Spielplanübersicht vervollständigt: Der öffentliche Spielplan trennt Turnhalle, Fußballplatz und Außenbereich in eigene Abschnitte, ordnet Hallen- und Fußballspiele nach den tatsächlich zugewiesenen Feldern und zeigt Außenwettbewerbe chronologisch. Veraltete Unterbereiche wie Rasen- oder Tartanplatz werden nicht mehr als Wettbewerbsort dargestellt; Wettbewerbe ohne Ortsangabe bleiben in einer eigenen Bestandsgruppe sichtbar.
- Übersicht und Turnierplanung sind nun über eine eindeutige Ansichtsumschaltung getrennt. Das Dashboard benennt Veranstaltung und Datum beim „Tagesplan der nächsten Veranstaltung“ ausdrücklich; wenn keine kommende Veranstaltung existiert, wird der letzte Tagesplan entsprechend gekennzeichnet.
- Spielplan-Bearbeitung als Zeitraster umgesetzt: Eine beim horizontalen Scrollen feste Zeitspalte richtet die Feldkarten an gemeinsamen Startzeiten aus; Drag & Drop taktet Quell- und Zielfeld aus Wettbewerbsstart, Spielzeit und Wechselzeit neu und zeigt Endzeitüberschreitungen als nicht blockierende Warnung. Die Dashboard-Fortschrittsanzeige bleibt strikt an Veranstaltungsdatum und lokale Uhrzeit gebunden.
- Dashboard-Fortschritt datumsfest gemacht: Zeitblöcke werden nur am tatsächlichen Veranstaltungsdatum als aktiv gewertet; zukünftige oder undatierte Veranstaltungen bleiben bei 0 %, laufende Blöcke verwenden die lokale Serverzeit und beendete Veranstaltungen erscheinen abgeschlossen mit 100 %.
