...
[ ] Gruppenbildung für KO-Runden generalisieren statt hart auf 6/7 Teams kodiert. Update 2026-09-13 (Issue #101): das faire Rundenverfahren selbst (`_generate_balanced_pairings`) ist bereits generisch für beliebige Teamzahl (dauerhaft per `tests/test_schedule_generator_robustness.py` für 3-32 Teams/gerade+ungerade abgesichert, vorher nur empirisch für N=4-13 geprüft) - offen bleibt die eigentliche Modus-Auswahl (Gruppenphase+KO vs. reine KO-Runde als eigener Strategie-Baustein, `competitions.turnier_modus`-Feld, UI im Wettbewerb-Formular), als Folge-PR zu Issue #101 vorgesehen
